    ...
    private void initializeProducts() {
        ...
        List<Product> products = Arrays.asList(
                createProduct(1L, "Classic Cotton T-Shirt", "classic-cotton-tshirt",
                        ...
                        Arrays.asList("S", "M", "L", "XL", "XXL"), Arrays.asList("White", "Black", "Navy", "Gray"),
                        true, true),
                ...
                createProduct(3L, "Premium Sneakers", "premium-sneakers",
                        ...
                        Arrays.asList("7", "8", "9", "10", "11", "12"), Arrays.asList("White", "Black", "Gray", "Navy"),
                        true, true),
                ...
                createProduct(7L, "Denim Jacket", "denim-jacket",
                        ...
                        Arrays.asList("S", "M", "L", "XL", "XXL"), Arrays.asList("Light Blue", "Dark Blue", "Black"),
                        true, false),
                ...
                createProduct(8L, "Silk Blouse", "silk-blouse",
                        ...
                        Arrays.asList("XS", "S", "M", "L", "XL"), Arrays.asList("White", "Cream", "Navy", "Black"),
                        true, true));

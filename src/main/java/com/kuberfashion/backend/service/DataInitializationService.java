...
public class DataInitializationService implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                // Users already exist in database, skip initialization
                // initializeUsers();
        }
        ...
        private void initializeCategories() {
                List<Category> categories = Arrays.asList(
                                ...
                                new Category("KVision Membership", "kvision",
                                                "https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                                                "Exclusive membership products - purchase to join referral program"),
        ...
        private void initializeProducts() {
                ...
                List<Product> products = Arrays.asList(
                                ...
                                createProduct(4L, "Leather Crossbody Bag", "leather-crossbody-bag",
                                                new BigDecimal("89.99"), new BigDecimal("119.99"), 25,
                                                accessoriesCategory,
                                                "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                                                Arrays.asList(
                                                                "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                                                ...
                                                Arrays.asList("One Size"), Arrays.asList("Brown", "Black", "Tan"), true,
                                                false),
                                ...
                                createProduct(5L, "Kids Rainbow Hoodie", "kids-rainbow-hoodie",
                                                ...
                                                new BigDecimal("4.4"), 67,
                                                "Colorful and comfortable hoodie for kids. Soft fabric with fun rainbow design.",
                                                Arrays.asList("2T", "3T", "4T", "5T", "6T"),
                                                Arrays.asList("Rainbow", "Pink Rainbow", "Blue Rainbow"), true, false),
                                ...
                                createProduct(6L, "Athletic Running Shorts", "athletic-running-shorts",
                                                ...
                                                new BigDecimal("4.3"), 94,
                                                "Lightweight running shorts with moisture-wicking technology. Perfect for workouts and outdoor activities.",
                                                Arrays.asList("S", "M", "L", "XL"),
                                                Arrays.asList("Black", "Navy", "Gray", "Red"), true, true),
        ...
        private void initializeUsers() {
                ...
                if (!userRepository.existsByPhone("1234567890")) {
                        try {
                                ...
                                // Ignore if creating user fails due to race condition or other constraint
                ...
                if (!userRepository.existsByPhone("0987654321")) {
                        try {
                                ...
                                // Ignore if creating user fails due to race condition or other constraint
                                System.out.println("Test user already exists: " + e.getMessage());
                        }
                }
        }
}
